...
struct ReplyOfReplyRowView: View {
    var body: some View {
        
        
        ZStack{
            RoundedRectangle(cornerRadius: 10).fill(Color(red: 0.95, green: 0.95, blue: 0.95))
                .frame(height: 120)
...
struct ReplyOfReplyRowView_Previews: PreviewProvider {
